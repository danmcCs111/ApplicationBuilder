...
public class ExtendedMinimizeActionListener implements ExtendedAttributeStringParam
{
	@Override
			...
			ab.addActionListener(new ActionListener() 
			{
				...
				public void actionPerformed(ActionEvent e) 
				{
					...
					if(wcp != null)
					{
						...
						if(o instanceof MinimizeActionExtension)
						{
							((MinimizeActionExtension) o).performMinimize();
						}
					}
				}
			});
