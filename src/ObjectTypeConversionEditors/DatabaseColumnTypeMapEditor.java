...
public class DatabaseColumnTypeMapEditor extends JButtonLengthLimited implements ParameterEditor, EditButtonArrayUrls
{
	...
	public DatabaseColumnTypeMapEditor()
	{
		buildWidgets();
	}
		...
		this.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) 
			{
				...
				databaseMapDialog = new DatabaseMapDialog(
						...
						DatabaseColumnTypeMapEditor.this, 
						TITLE_TEXT
				);
				databaseMapDialog.setLocation(DatabaseColumnTypeMapEditor.this.getLocationOnScreen());
	...
	public void setComponentValue(Object value) 
	{
		...
		databaseMap = (DatabaseColumnTypeMap) value;
	...
	{
		return DatabaseColumnTypeMap.class.getName();
	}
