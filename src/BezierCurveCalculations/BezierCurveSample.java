...
public class BezierCurveSample 
{
	public static Point getPointAtCubicCurve(Point start, Point control1, Point control2, Point end, double tStep) 
	{
		...
		double x = (start.getX() * inverseTStepCubed + 3 * control1.getX() * tStep * inverseTStepsquared)
		        + (3 * control2.getX() * tStepSquared * inverseTStep + end.getX() * tStepCubed);
		double y = (start.getY() * inverseTStepCubed + 3 * control1.getY() * tStep * inverseTStepsquared)
		        + (3 * control2.getY() * tStepSquared * inverseTStep + end.getY() * tStepCubed);
