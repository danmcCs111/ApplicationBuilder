...
public class XmlToWidgetGenerator 
{
	private String 
		methodName;
	private ArrayList<StringToObjectConverter> 
		stringToObjectConverterList = new ArrayList<StringToObjectConverter>();
	private ArrayList<ParameterEditor> 
	...
	private void addParameterEditor(StringToObjectConverter soc, List<String> params)
	{
		...
		LoggingMessages.printOut("" + soc.getDefinitionClass() + " parm editor: " + pe.getClass());
