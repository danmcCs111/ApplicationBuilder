...
public class VideoQueuePlayer extends JFrame
{
	...
	public VideoQueuePlayer(HashMap <Integer, ArrayList <YoutubeChannelVideo>> ycvs, JButtonLengthLimited jbllParent, Container parent)
	{
