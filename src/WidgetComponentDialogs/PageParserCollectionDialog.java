...
public class PageParserCollectionDialog extends JDialog 
{
	...
	public static void main(String [] args)
	{
		PageParserCollection ppc = new PageParserCollection(
				...
				"GOG@F@gog.com@F@Image@F@@M@product-tile[^@Q@]*@Q@ href=@Q@[^@Q@]*@Q@.*.jpg@R@product-tile[^@Q@]*@Q@ href=@Q@@RV@@R@(@Q@)$@RV@@M@[^\\s]*.jpg@R@srcset=@Q@@RV@@F@Title@F@@M@product-tile[^@Q@]*@Q@ href=@Q@[^@Q@]*@Q@.*.jpg@R@product-tile[^@Q@]*@Q@ href=@Q@@RV@@R@(@Q@).*.jpg$@RV@"
				);
