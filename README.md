...
(building in **linux** uses ./configure && make)
...
*added touch controls & toggle button (tablet / car mount mode), youtube handle editor and status bar.

<img width="%25" width="412" height="149" alt="image" src="https://github.com/user-attachments/assets/d91b89d0-4f72-4691-bdb5-7150767e6128" />
